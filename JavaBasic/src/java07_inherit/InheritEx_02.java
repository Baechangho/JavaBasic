...
//		super.display();	//this랑 비슷 -> 상속받은 자식클래스에서 부모클래스를 지칭
	}
	public void print() {
...
//		((Parent2)c).display();
		...
		pc.num = 555;		//객체변수의 데이터타입을 따라간다(pc의 데이터타입 Parent2)
		
		//동적 바인딩, 인스턴스인 Child2타입의 display()메소드가 실행된다
		pc.display();
		
		
		//에러, Parent2타입에 print()메소드가 존재하지 않는다
//		pc.print(); //자식 고유멤버는 부모타입을 통해서 접근 불가
