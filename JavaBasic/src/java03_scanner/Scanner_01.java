...
//클래스 정식 이름 : 패키지.이름 (java03_scanner.Scanner_01)

//import 선언
// -> 현재 소스코드에서 java.util.Scanner 클래스의 이름을
// 패키지를 생략하고 Scanner로 사용하겠다
//	import java.lang.String;		//<-를 import하면
//	java.lang.String name = "Bob";	//<-라고 안써도
//	String name = "Bob";			//<-라고 할수있다
...
//		String name;
		...
		//자동 import : ctrl + shift + O (Organize Imports)
