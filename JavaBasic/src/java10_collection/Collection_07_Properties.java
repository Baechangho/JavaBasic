...
//		prop.setProperty("A", 100);
		...
		try {
			...
			//파일 출력 스트림 생성
			//	-> 파일이 없을 경우 파일도 생성해준다
//			writer = new FileWriter("C:\\Users\\user1\\git\\JavaBasic\\JavaBasic\\src\\java10_collection\\user.properties");
			writer = new FileWriter("C:/Users/user1/git/JavaBasic/JavaBasic/src/java10_collection/user.properties");
		...
		Properties test = new Properties();
			...
			//파일 입력 스트림 생성
			try {
				reader = new FileReader("C:/Users/user1/git/JavaBasic/JavaBasic/src/java10_collection/user.properties");
