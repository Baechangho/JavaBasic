...
//		System.out.println("num1 + num2 = 16" + num2);
//		System.out.println("num1 + num2 = 166");
		...
		System.out.println(num1 / (double)num2);	//변수값불러오기
		System.out.println(16 / (double)6);			//강제형변환
		System.out.println(16 / 6.0);				//자동형변환
		System.out.println(2.6666666666666665);		//나눗셈
